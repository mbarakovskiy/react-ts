...
class UserTableRow extends React.Component<UserTableRowProps> {
    ...
    shouldComponentUpdate(nextProps: UserTableRowProps) {
        ...
        const previousUser = this.props.user;
        const currUser = nextProps.user;

        return (
            previousUser.firstName !== currUser.firstName ||
            previousUser.surname !== currUser.surname ||
            (previousUser.dateOfBirth !== currUser.dateOfBirth &&
                helpers.calculateAge(previousUser.dateOfBirth) !== helpers.calculateAge(currUser.dateOfBirth))
        );
    }
}
